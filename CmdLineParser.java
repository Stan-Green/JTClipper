 ...
 * @see jargs.examples.gnu.OptionTest
 ...
 Change Log:
 Stan Green - 3/25/2008
 Added an option that expects an date value in the format of MM/DD/YYYYY
...
public class CmdLineParser {
    ...
    public static abstract class Option {
        ...
        public static class StringOption extends Option {
            ...
            protected Object parseValue( String arg, Locale locale ) {
				...
				/**
				 An option that expects an date value in the format of MM/DD/YYYYY. 
				 Seperators of . and - are also acceptable.
				 (OK, so it will also take YYYY/MM/DD but converts it or MM/DD/YYYY.)
				 Added by Stan Green on 3/25/2008
				 */
				public static class DateOption extends Option
				{
						...
						throws IllegalOptionValueException
					{
						...
						if(4 == lsDate.indexOf('/'))
						{
							//This format is YYYY/MM/DD so reset to MM/DD/YYYY
							lsDate = lsDate.substring(5,7) + "/" + lsDate.substring(8,10) + "/" + lsDate.substring(0,4);
						}
						...
						try
						{
							...
							return loDateFormat.parse(lsDate);
						}
						catch (ParseException e)
						{
							throw new IllegalOptionValueException(this, arg);
    ...
    public final Option addBooleanOption( String longForm ) {
     ...
     @return the new Option
		 Added by Stan Green on 3/25/08
    */
    public final Option addDateOption( char shortForm, String longForm )
		{
    ...
    /**
      ...
      @return the new Option
			Added by Stan Green on 3/25/08
    */
    public final Option addDateOption( String longForm )
		{
